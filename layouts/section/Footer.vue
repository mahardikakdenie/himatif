<template>
  <footer class="p-4 bg-red-900 sm:p-6">
    <div class="md:flex md:justify-between">
      <div class="mb-6 md:mb-0">
        <a href="https://flowbite.com/" class="flex items-center">
          <img src="himatif.png" class="mr-3 h-8" alt="FlowBite Logo" />
          <span
      ...
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        <div>
          <h2
            class="mb-6 text-sm font-semibold text-white uppercase text-white"
          >
            Resources
          </h2>
          <ul class="text-white">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-white sm:text-center text-white"
        >© 2022
